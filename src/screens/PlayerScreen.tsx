  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.progressContainer}>
        <View style={[styles.progressBar, { width: `${(position / (duration || 1)) * 100}%` }]} />
      </View>
      ...
      <TouchableOpacity style={styles.saveButton} onPress={handleSaveTrack}>
        <Text style={styles.saveText}>⬇ Guardar Localmente</Text>
      </TouchableOpacity>
    </View>
  );
};
...
const styles = StyleSheet.create({
  ...
  saveButton: { backgroundColor: COLORS.surface, padding: 14, borderRadius: 8, alignItems: 'center' },
